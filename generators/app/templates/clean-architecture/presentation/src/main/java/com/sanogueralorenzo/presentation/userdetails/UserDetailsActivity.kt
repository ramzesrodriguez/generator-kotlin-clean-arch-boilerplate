...
import <%= appPackage %>.presentation.getAppInjector
import <%= appPackage %>.presentation.model.USER_ID_KEY
import <%= appPackage %>.presentation.model.UserItem
import <%= appPackage %>.presentation.observe
import <%= appPackage %>.presentation.withViewModel
