...
import <%= appPackage %>.data.createPostEntity
import <%= appPackage %>.data.model.PostEntity
import <%= appPackage %>.data.model.PostMapper
import <%= appPackage %>.data.remote.PostsApi
